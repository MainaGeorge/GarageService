...
namespace SparkAuto.EmailServices
{
    public class MessageTemplate
    {
        ...
        public string Message => $"Dear {_user.Name}, \nWe are pleased to inform you that your vehicle {_car.Make} {_car.Model}, " +
                                 $"\nwith the registration number {_car.RegistrationNumber} has been successfully serviced as per your request.\n" +
